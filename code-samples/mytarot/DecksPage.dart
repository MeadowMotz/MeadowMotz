// page for viewing and managing digital deck
...
class _DecksPageState extends State<DecksPage> {
  ...
  // finds index of card with query term
  int? searchCard(String searchTerm) {
    final List<String> terms = searchTerm.split(' ');
    // Iterate over the map to find indeces that contain the search term
    for (var entry in cards.entries) {
      ...
      if (found) {
        ...
        return num;  // file index on match
      }
    }
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                onSubmitted: (String search) {
                  if (selectedDeck=='No deck selected') { // validate
                    ...
                    // animate carousel to slide to query match card
            ...
            // expandable card management menu
