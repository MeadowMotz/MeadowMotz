// page for adjusting image edges before homography and labelling card
...
class _EditorPageState extends State<EditorPage> {
  ...
  // Initialize the image parameters for scaling to resolution
  void _loadImageSize() {
                  ...
                  SizedBox(
                    ...
                    child: Stack(
                      children: [
                        ...
                        // Draw interactive quadrilateral overlay
                        if (corners.length == 4)
                          Positioned.fill(
                            child: CustomPaint(
