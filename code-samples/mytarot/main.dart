// main page for card management, navigation to other pages
...
class _MyHomePageState extends State<MyHomePage> {
 ...
 @override
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Row(
            children: [
              _displayRectifiedImage(), // shows adjusted image
  ...
  // send input image for backend edge detection
  ...
  // send input image for backend homography, etc
  ...
  // insert processed image to application scaffold
            ...
            Column(
              ...
              children: <Widget>[
                ...
                if (selectedDeck == 'Add new deck')
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(height: 10),
                        // deck name submit button
                        ElevatedButton(
                          onPressed: () {
                            String newDeck = newDeckController.text.trim();
                            if (newDeck.isNotEmpty && !dropdownOptions.contains(newDeck)) { // input validation
                              setState(() {
                  ...
                  // When deck selected and rectified image available, add card
